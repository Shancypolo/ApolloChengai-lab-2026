...
def make_result(
    ...
    *,
    ...
    """Build typed API results with valid defaults for focused test cases."""
...
class RuntimeImportTests(unittest.TestCase):
    """Test certificate-bundle validation and optional transport availability."""
...
class MemoryFileTests(unittest.TestCase):
    """Test read-only seed loading, malformed input, and fresh session state."""
...
class MemoryDeltaTests(unittest.TestCase):
    """Test atomic delta operations, duplicate events, limits, and retcon rules."""
...
class GenerationTests(unittest.TestCase):
    """Test API contract, AI classifications, story limits, and session updates."""
